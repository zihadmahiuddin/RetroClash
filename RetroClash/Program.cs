        ...
        public async Task StartAsync()
        {
            ...
            while (true)
            {
                ...
                switch (key)
                {
                    ...
                    {
                        Console.WriteLine(
                            $"[STATUS] Online Players: {Resources.Cache.Players.Count}, Players Saved: {await MySQL.PlayerCount()}");
                        break;
                    }
                    ...
                    {
                        Console.WriteLine(
                            "Do you want to create 1000 Test Accounts? If yes press enter. To Abort any key than enter.");
